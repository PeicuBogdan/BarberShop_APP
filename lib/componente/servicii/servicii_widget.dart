...
import 'servicii_model.dart';
export 'servicii_model.dart';

class ServiciiWidget extends StatefulWidget {
  const ServiciiWidget({super.key});

  @override
  State<ServiciiWidget> createState() => _ServiciiWidgetState();
}

class _ServiciiWidgetState extends State<ServiciiWidget> {
  late ServiciiModel _model;
