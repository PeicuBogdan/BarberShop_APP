...
import 'schema/offered_services_record.dart';
...
export 'schema/offered_services_record.dart';
...
/// Functions to query OfferedServicesRecords (as a Stream and as a Future).
Future<int> queryOfferedServicesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      OfferedServicesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<OfferedServicesRecord>> queryOfferedServicesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      OfferedServicesRecord.collection,
      OfferedServicesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<OfferedServicesRecord>> queryOfferedServicesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
