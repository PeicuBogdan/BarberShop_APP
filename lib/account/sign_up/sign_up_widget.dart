                                          ...
                                          children: [
                                            Align(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'SIGN_UP_DO_YOU_HAVE_AN_ACCOUNT?_BTN_ON_T');
                                                  logFirebaseEvent(
                                                      'Button_navigate_to');
                                                ...
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'u56gugdq' /* Do you have an account? */,
                                                ),
                                                options: FFButtonOptions(
                                                  width: 220.0,
                                                  height: 25.0,
